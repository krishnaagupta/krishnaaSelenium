...
public class LaunchWalmart {
	public static void main(String args[]) throws MalformedURLException, InterruptedException{
	AppiumDriver<MobileElement> driver;
	URL url=new URL("http://0.0.0.0:4723/wd/hub");
	DesiredCapabilities dc=new DesiredCapabilities();
	dc.setCapability(AndroidMobileCapabilityType.APP_PACKAGE,"com.kohls.mcommerce.opal");
	dc.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.kohls.mcommerce.opal.framework.view.activity.HomeActivity");
